...
export const useAppearance = () => {
  ...
  const isDark = useCookie<boolean>('appearance_is_dark', {
    default: () => true,
  });
  const density = useCookie<Density>('appearance_density', {
    default: () => 'default',
  });
  const primaryColor = useCookie<string>('appearance_primary_color', {
    default: () => '#FFFFFF',
  });
