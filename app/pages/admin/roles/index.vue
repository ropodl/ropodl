...
const deleteRole = async (id: number) => {
  ...
  await useApiFetch(`rbac/roles/${id}`, { method: 'DELETE' }).then(() => {
    ...
    <v-row>
      ...
      <v-col cols="12" md="8">
        ...
        <v-card
          v-else
          variant="outlined"
          class="rounded-lg d-flex align-center justify-center py-16 text-grey"
        >
    ...
    <v-dialog v-model="roleDialog" max-width="500px">
      <v-card title="Create New Role" class="rounded-lg">
        ...
        <v-card-actions>
          ...
          <v-btn color="primary" variant="flat" @click="createRole"
            >Create</v-btn
          >
        </v-card-actions>
      </v-card>
      ...
      <v-card title="Create New Permission" class="rounded-lg">
        <v-card-text>
          <v-text-field
            ...
            label="Permission Name (e.g. media.delete)"
            variant="outlined"
            class="mb-4"
          />
          <v-textarea
        ...
        <v-card-actions>
          ...
          <v-btn color="primary" variant="flat" @click="createPermission"
            >Create</v-btn
          >
        </v-card-actions>
      </v-card>
