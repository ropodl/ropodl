      ...
      <v-row>
         <v-col>
            <layouts-default-page-title>
               <span class="text-primary-darken-2">About me,</span> my story and
               my experience.
            </layouts-default-page-title>
         </v-col>
      </v-row>
      <v-row>
         ...
         >
            <div class="text-h6 font-weight-light mb-6">
               <p>
                  As a Senior Fullstack Developer with over 6 years of
                  experience, I specialize in creating intuitive and
                  user-centered interfaces for a wide range of digital products
                  and experiences. I work across the entire development stack,
                  building backend systems and frontend interfaces with clean,
                  maintainable code.
               </p>
               <br />
               <p>
               ...
               <br />
               <p>
                  I've collaborated with designers, product managers, and
                  developers to ship products that meet business goals. Whether
                  starting new projects or improving existing ones, I approach
                  problems methodically and deliver software that works reliably
