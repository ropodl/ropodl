...
<template>
    <v-skeleton-loader :loading="loading" width="100%" height="600" type="image">
        <!-- <template v-if="post.featuredImage">
            <v-img cover class="d-flex align-end" height="600" :src="post.featuredImage?.url">
                <v-container>
                    <v-row>
                        <v-col cols="12">
                            <v-card-title class="text-h2" style="white-space: unset !important;">{{ post.title }}</v-card-title>
                        </v-col>
                    </v-row>
                </v-container>
            </v-img>
        ...
        <v-row>
            <v-col cols="12" md="3">
                <v-card flat color="transparent">
                    <v-card-text class="px-0 text-overline">Published at: {{ formatTimeAgo(new Date(post.createdAt)) }}</v-card-text>
                </v-card>
                <v-divider></v-divider>
                <v-card flat color="transparent">
            ...
            <v-col cols="12" md="9">
                ...
                <v-divider></v-divider>
                <v-card flat color="transparent">
                    <v-card-text class="text-overline" style="white-space: normal;">Published at: {{ formatTimeAgo(new Date(post.createdAt)) }}</v-card-text>
                </v-card>
            </v-col>
        </v-row>
    </v-container>
